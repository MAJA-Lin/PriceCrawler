...
use MichaelSchrenk\Bundle\Library\Http;
use MichaelSchrenk\Bundle\Library\Parse;
use MichaelSchrenk\Bundle\Library\ResolveAddresses;
...
class DownloadImages
{
    ...
    ***********************************************************************/
    public function download_binary_file($file, $ref)
    {
    ...
    ***********************************************************************/
    ...
    OUTPUT:
            ...
            original directory structure
    ***********************************************************************/
    public function download_images_for_page($target)
    {
        echo "target = $target\n";
