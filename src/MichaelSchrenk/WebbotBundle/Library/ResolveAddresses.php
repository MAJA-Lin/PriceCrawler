...
class ResolveAddress
{
    ...
    ***********************************************************************/
    public function get_base_page_address($url)
    {
    ...
    ***********************************************************************/
    public function get_base_domain_address($page_base)
    {
    ...
    -------------------------------------------------------------
    */
    public function move_address_back_one_level($page_base, $object_source)
    {
