...
class Pop3
{
    ...
    ***********************************************************************/
    public function POP3_connect($server, $user, $pass)
    {
        $error="";
    ...
    ***********************************************************************/
    public function POP3_list($handle)
    {
        // Initialization
        $list_array = array();
        $reply="";
    ...
    ***********************************************************************/
    public function POP3_retr($handle, $id)
    {
        // Initialize
        $flag="";
        $message="";
    ...
    INPUT:
            $handle           From POP3_connect() function
    ***********************************************************************/
    public function POP3_delete($handle, $id)
    {
    ...
    INPUT:
            $handle           From POP3_connect() function
    ***********************************************************************/
    public function POP3_quit($handle)
    {
        fputs($handle, "QUIT\n");
        $reply = fgets($handle);
        return $reply;
