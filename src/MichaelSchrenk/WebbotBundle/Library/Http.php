...
class Http
{
    ...
    ***********************************************************************/
    ...
    OUTPUT:
            ...
            $return_array['ERROR']  = CURL generated error status
    ***********************************************************************/
    public function http_get_withheader($target, $ref)
    {
    ...
    OUTPUT:
            ...
            $return_array['ERROR']  = CURL generated error status
    ***********************************************************************/
    public function http_get_form($target, $ref, $data_array)
    {
        return $this->http($target, $ref, $method="GET", $data_array, EXCL_HEAD);
    }
    ...
    OUTPUT:
            ...
            $return_array['ERROR']  = CURL generated error status
    ***********************************************************************/
    public function http_get_form_withheader($target, $ref, $data_array)
    {
        return $this->http($target, $ref, $method="GET", $data_array, INCL_HEAD);
    }
    ...
    OUTPUT:
            ...
            $return_array['ERROR']  = CURL generated error status
    ***********************************************************************/
    public function http_post_form($target, $ref, $data_array)
    {
        return $this->http($target, $ref, $method="POST", $data_array, EXCL_HEAD);
    }

    public function http_post_withheader($target, $ref, $data_array)
    {
        return $this->http($target, $ref, $method="POST", $data_array, INCL_HEAD);
    }

    public function http_header($target, $ref)
    {
    ...
    ***********************************************************************/
    public function http($target, $ref, $method, $data_array, $incl_head)
    {
        ...
        curl_setopt($ch, CURLOPT_SSL_VERIFYHOST, 0);        // Add to make sure ssl connection normal
