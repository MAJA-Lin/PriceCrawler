...
class SimpleSpider
{
    ...
    ***********************************************************************/
    public function harvest_links($url)
    {
        # Initialize
        global $DELAY;
        $link_array = array();
    ...
    ***********************************************************************/
    public function archive_links($spider_array, $penetration_level, $temp_link_array)
    {
    ...
    ***********************************************************************/
    ...
    RETURNS:
            ...
            excluded
    ***********************************************************************/
    public function excluded_link($spider_array, $link) {
        # Initialization
