...
class BookController extends Controller
{
    ...
    /**
     * Get weekly discount book infomation. Due to the UTF-8 json problem,
     * reciver must remember to urldecode & unserialize the data.
     *
     * @Route(
    ...
    public function weeklyDiscountAction(Request $request, $source)
    {
        ...
        try {
            ...
            $result = [
                'status' => 'successful',
                'data' => urlencode(serialize($page->getBookInfo())),
            ];
