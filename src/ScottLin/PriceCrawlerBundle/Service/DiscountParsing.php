...
use ScottLin\PriceCrawlerBundle\Library\BookDiscountInfo;
...
class DiscountParsing
{
    ...
    public function bookParsing()
    {
        ...
        $todayArray = [
            "sanmin" => [
                "begin" => "<td valign=\"top\" background=\"images/Today66/index_05.gif\">",
                "end" => "<tr><td ><img src=\"images/Today66/index_06.gif\"></td></tr>",
                "name_begin" => "<td align=\"left\" valign=\"top\" class=\"book\" style=\"padding-left:5px;\"><a href=\"http://www.m.sanmin.com.tw/Product/Index/",
                "name_end" => "</a></td>",
                "price_begin" => "66折優惠價：<span>",
                "price_end" => "</span> 元",
                "label_price_begin" => "",
                ...
                "discount_begin" => "class=\"gray\" >",
                "discount_end" => "折優惠價：",
                "book_link_begin" => "padding-left:5px;\"><a href=\"",
                "book_link_end" => "\">",
                "img_begin" => "original=\"",
                "img_end" => "\" alt",
                "date_begin" => "font-weight:bold\">",
        ...
        $page = new BookDiscountInfo($link[$source], $ref, "GET", "", $source);
        ...
        $page->setDataFetchingTags($tagArray[$source]);
        $page->setSplitTags($splitArray[$source]);
        ...
        $page->returnBookInfo($parsingResult['FILE'], false);
        $finalPage = $page->getBookInfo();

        if ($source == 'sanmin') {
            $page->setDataFetchingTags($todayArray[$source]);
            $page->returnBookInfo($parsingResult['FILE'], true);
            $todayBook = $page->getBookInfo();
            array_unshift($finalPage, $todayBook[0]);
        }
